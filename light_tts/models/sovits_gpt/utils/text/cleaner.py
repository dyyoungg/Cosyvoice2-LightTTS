# from light_tts.models.sovits_gpt.utils.text import chinese, japanese, cleaned_text_to_sequence, symbols, english

from light_tts.models.sovits_gpt.utils.text import cleaned_text_to_sequence,symbols_v2
import os
...
def clean_text(text, language, version=None):
    ...
    language_module = __import__("lightllm.models.sovits_gpt.utils.text."+language_module_map[language],fromlist=[language_module_map[language]])
...
def clean_text_inf(text, language, version='v2'):
