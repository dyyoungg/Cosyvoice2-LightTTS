...
from light_tts.models.sovits_gpt.utils.text.symbols import punctuation
from light_tts.models.sovits_gpt.utils.text.tone_sandhi import ToneSandhi
from light_tts.models.sovits_gpt.utils.text.zh_normalization.text_normlization import TextNormalizer
...
if is_g2pw:
    ...
    from light_tts.models.sovits_gpt.utils.text.g2pw import G2PWPinyin, correct_pronunciation
    parent_directory = os.path.dirname(current_file_path)
    g2pw = G2PWPinyin(model_dir="G2PWModel",model_source="chinese-roberta-wwm-ext-large",v_to_u=False, neutral_tone_with_five=True)
