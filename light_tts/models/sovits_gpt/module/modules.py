...
from light_tts.models.sovits_gpt.module.transforms import piecewise_rational_quadratic_transform
...
class WN(torch.nn.Module):
    ...
    def forward(self, x, x_mask, g):
        ...
        for i, (inlayer, res_layer) in enumerate(zip(self.in_layers, self.res_skip_layers)):
            x_in = inlayer(x)
