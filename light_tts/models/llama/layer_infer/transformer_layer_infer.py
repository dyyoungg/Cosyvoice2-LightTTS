...
from light_tts.models.llama.splitfuse_infer_struct import SplitFuseInferStateInfo
...
from light_tts.models.llama.triton_kernel.splitfuse_context_flashattention_nopad import (
...
class LlamaTransformerLayerInfer(TransformerLayerInferTpl):
    ...
    def _ffn_norm(
        ...
        # return layer_weight.ffn_norm_weight_ * input.to(input_dtype)
    ...
    def _get_qkv(
        ...
        if hasattr(layer_weight, "q_bias_"):
    ...
    def _ffn(self, input, infer_state: LlamaInferStateInfo, layer_weight: LlamaTransformerLayerWeight) -> torch.Tensor:
        ...
        # ffn1_out = torch.nn.functional.silu(up_gate_out[:, 0: intermediate_size]) * up_gate_out[:, intermediate_size:]
        input = None
        up_gate_out = None
    ...
    def _token_decode_attention_ppl_int8kv(self, q, infer_state: LlamaInferStateInfo, layer_weight, out=None):
        ...
        from light_tts_ppl_kernel import group8_int8kv_decode_attention
