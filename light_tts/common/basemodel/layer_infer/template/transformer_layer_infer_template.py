...
class TransformerLayerInferTpl(TransformerLayerInfer):
    ...
    def _att_norm(self, input, infer_state:InferStateInfo, layer_weight)->None:
        raise Exception("need to impl")
    
    def _ffn_norm(self, input, infer_state:InferStateInfo, layer_weight)->None:
        raise Exception("need to impl")
    ...
    # @mark_cost_time("trans token attention forward time cost")
    ...
    # this impl dont to use @mark_cost_time
    # @mark_cost_time("trans token ffn forward time cost")
